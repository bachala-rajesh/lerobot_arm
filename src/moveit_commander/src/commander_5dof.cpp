...
// 5dof arm variant. joint_command expects 5 values. See commander_6dof.cpp for 6dof.
...
public:
    ...
    {
        gripper_->setStartStateToCurrentState();
        gripper_->setNamedTarget("OPEN_HALF");
        planAndExecute(gripper_);
    }
...
int main(int argc, char **argv)
{
    ...
    auto node = std::make_shared<rclcpp::Node>("commander_5dof", "follower");
