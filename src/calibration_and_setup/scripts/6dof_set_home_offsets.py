#!/usr/bin/env python3
"""
Compute and write home offsets in one step — 6DOF variant (7 servos, wrist_yaw added)
======================================================
...
filename = f'6dof_{args.arm}_{now.strftime("%Y-%m-%d_%H-%M-%S")}.yaml'
filepath = os.path.join(backup_dir, filename)

with open(filepath, 'w') as f:
    f.write(f'# Calibration backup (6DOF)\n')
