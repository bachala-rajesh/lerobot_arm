Here's how to integrate a VLM into this repo. Good news — you already have most of the building blocks; what's missing is the ROS glue.
  ...
  ├───────────────────────────────────────────┼───────────────────────────────────────────────────────────────────────────────────────────────────────────────────┤
  │ VLM ↔ ROS interfaces                      │ ❌ project_interfaces/ has audio + pose msgs, nothing for vision/VLM                                                │
  ├───────────────────────────────────────────┼───────────────────────────────────────────────────────────────────────────────────────────────────────────────────┤
  ...
  1. Turn visual_language_reasoning/ into a real ROS 2 ament_python package
    - Add package.xml (depends: rclpy, sensor_msgs, cv_bridge, project_interfaces)
  ...
  2. Add a VLMResult.msg to project_interfaces/
  ...
  float32 confidence
  2. Register it in project_interfaces/CMakeLists.txt.
